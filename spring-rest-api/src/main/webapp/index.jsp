...
<head>
  ...
  <link href='<c:url value="/resources/css/typography.css"/>' media='screen' rel='stylesheet' type='text/css'/>
  <link href='<c:url value="/resources/css/reset.css"/>' media='screen' rel='stylesheet' type='text/css'/>
  <link href='<c:url value="/resources/css/screen.css"/>' media='screen' rel='stylesheet' type='text/css'/>
  <link href='<c:url value="/resources/css/reset.css"/>' media='print' rel='stylesheet' type='text/css'/>
  <link href='<c:url value="/resources/css/print.css"/>' media='print' rel='stylesheet' type='text/css'/>

  <script src='<c:url value="/resources/lib/object-assign-pollyfill.js"/>' type='text/javascript'></script>
  ...
  <script src='<c:url value="/resources/lib/highlight.9.1.0.pack.js"/>' type='text/javascript'></script>
  <script src='<c:url value="/resources/lib/highlight.9.1.0.pack_extended.js"/>' type='text/javascript'></script>
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="http://swagger.io"><img class="logo__img" alt="swagger" height="30" width="30" src="<c:url value="/resources/images/logo_small.png"/>" /><span class="logo__title">swagger</span></a>
